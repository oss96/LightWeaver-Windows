# Claude Code Instructions for LightWeaver
...
## Maintainer setup
If `.claude/internal/agent/CLAUDE.md` exists in this checkout, read it before doing anything else; it carries the maintainer's private environment, verification and release process, and overrides this file where they differ. Public clones do not have it and need nothing from it.
